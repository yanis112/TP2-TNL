...
#co_occurrence_matrix, vocabulaire = create_co_occurrence_matrix(texte, window_size)



# Affichage de la matrice de co-occurrence et du vocabulaire
#print("Matrice de co-occurrence:")
#print(co_occurrence_matrix)
#print("nombre de 0:")
#non_nulles = np.count_nonzero(co_occurrence_matrix)
#print("VALEURS NON NULLES ",non_nulles)
#print("\nVocabulaire:")
...
def train_word_embeddings(text, embedding_size, k, window_size,learning_rate):
    ...
    for iteration in range(k):
        ...
        for target_word_index, target_word in enumerate(tqdm(text)):
            ...
            negative_samples = [word for word in text if word != target_word][:4]
...
# Paramètres
embedding_size = 50  # Taille des embeddings (ajustez selon vos besoins)
k = 1  # Nombre d'itérations (ajustez selon vos besoins)
...
trained_word_embeddings,list_loss = train_word_embeddings(texte, embedding_size, k, window_size,learning_rate)
